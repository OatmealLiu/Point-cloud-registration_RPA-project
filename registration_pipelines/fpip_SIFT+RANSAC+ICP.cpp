/*
* Pipepline: SIFT --> RANSAC --> ICP [tested]
...
int main()
{
    ...
    */
    // ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    // Feature Extraction + Feature Descriptor: run SIFT
    // ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    PointCloud::Ptr rSIFTDesc_src(new PointCloud);
    PointCloud::Ptr rSIFTDesc_tar(new PointCloud);
    pcl::copyPointCloud(*iKeypoints_src, *rSIFTDesc_src);
    pcl::copyPointCloud(*iKeypoints_tar, *rSIFTDesc_tar);

    pcl::io::savePCDFileASCII(filename_desc_sift_src, *rSIFTDesc_src);
    pcl::io::savePCDFileASCII(filename_desc_sift_tar, *rSIFTDesc_tar);
    ...
    scia.setSourceFeatures(rSIFTDesc_src);
    scia.setTargetFeatures(rSIFTDesc_tar);
    ...
    std::cout << "------> Saved evaluation result '" << datastream::filename_pip_sift << "', run run Miumiu run...\n";
